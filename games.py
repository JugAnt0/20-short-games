...
print("Welcome to my 20-game gallery!")
time.sleep(1)
while True:
    print("Choose what game you want to play:")
    print("1.- Secret Santa")
    print("2.- Two Truths and a Lie")
    print("3.- Mafia")
    print("4.- House Decor")
    print("5.- Fortune Telling")
    print("6.- Outfit Inspo")
    print("7.- Sheep Game")
    print("8.- Mult Game")
    print("9.- Balloon Pop")
    print("10.- Story Adventure")
    print("11.- Dice Race")
    print("12.- Trivia")
    print("13.- Treasure Hunt")
    print("14.- Simon Says")
    print("15.- Memory (Pairs)")
    print("16.- Math Quiz")
    print("17.- Guess the Word")
    print("18.- Rock Paper Scissors")
    print("19.- Tic Tac Toe")
    print("20.- Hide and Seek")

    choice = int(input("Choose a game (1-20): "))
    time.sleep(4)
    print("Ok, loading game now...")
    time.sleep(2)
    ...
    #3 MAFIA
        ...
        while True:
            ...
            if not (4 <= num_players <= 10):
                rint("Invalid number of players. Please enter a number between 4 and 10.")
                continue
    ...
    # ANTONIO'S FORTUNE TELLING
        ...
        while True:
            ...
            if p == 'yes':
                ...
                if op == 1:
                    f = [
                        "You will face a great tragedy soon.",
                    ...
                    b = [
                        "You will find clarity in unexpected places.",
    ...
    # STORY ADVENTURE
        ...
        def story_adventure():
            ...
            choice1 = input(
                "You stand before two doors inside the temple. One is red, the other blue.\nWhich door do you choose? (red/blue): "
            ).lower()

            if choice1 == "red":
                print("\nYou push the heavy red door open. A torch-lit hallway stretches ahead...")
                choice2 = input(
                    "You see a strange statue holding a glowing gem. Do you (take) the gem or (ignore) it? "
                ).lower()
                ...
                if choice2 == "take":
                    ...
                    if choice3 == "run":
                        ending(
                            "You dash ahead and escape into a treasure chamber filled with gold! You live a life of fortune."
                        )
                    else:
                        ending(
                            "The hallway collapses behind you. You are trapped forever in darkness..."
                        )
                else:
                    print(
                    ...
                    choice3 = input(
                        "At the end, you find a fork: (left) leads to chanting, (right) smells of fresh air. Which way? "
                    ).lower()
                    if choice3 == "left":
                        ending(
                            "You find a secret cult performing rituals. They welcome you as their chosen one. You never leave..."
                        )
                    else:
                        ending(
                            "You emerge safely outside the temple, richer in wisdom but without treasure."
                        )

            elif choice1 == "blue":
                print("\nThe blue door creaks open, revealing a cold, misty chamber.")
                choice2 = input(
                    "In the center lies a frozen pedestal with a book. Do you (read) the book or (leave) it? "
                ).lower()
                ...
                if choice2 == "read":
                    ...
                    if choice3 == "accept":
                        ending(
                            "You gain control of time itself! You become a legend... but vanish from the world forever."
                        )
                    else:
                        ending(
                            "You close the book respectfully. A hidden door opens, leading you safely out. You live, wiser and humbler."
                        )
                else:
                    print("\nYou ignore the book and move forward. Suddenly, you hear growling...")
                    choice3 = input(
                        "A shadowy beast blocks your path! Do you (fight) it or (flee)? "
                    ).lower()
                    if choice3 == "fight":
                        ending(
                            "With bravery, you fight the beast... but it overpowers you. The temple claims another victim."
                        )
                    else:
                        ending(
                            "You sprint away and find a hidden passage that leads to freedom. You survive, but the mystery remains unsolved."
                        )

            else:
                ending(
                    "You hesitate too long. The temple collapses, burying its secrets forever... and you with it."
                )
        ...
        def memory_game():
            ...
            while not all(revealed):
                ...
                try:
                    ...
                    if (
                        choice1 == choice2
                        or not (0 <= choice1 < len(pairs))
                        or not (0 <= choice2 < len(pairs))
                    ):
